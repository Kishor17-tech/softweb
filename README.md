...
<body>
    ...
    <section class="home-hero">
        <div class="hero-content">
            <h1>Fly High Restaurant</h1>
            <p>"Taste your own food and reach your destination"</p>
        </div>
    </section>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Menu - Fly high Restaurant</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <nav>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Administration - Fly high Restaurant</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <nav>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Contact Us - Fly high Restaurant</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <nav>
    ...
    <section class="contact-box">
        ...
        <h3>Email: krkishor@gmail.com</h3>
    </section>
